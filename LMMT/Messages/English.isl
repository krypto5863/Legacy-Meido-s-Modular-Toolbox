...
SelectDirLabel3=Please select your CM3D2 install directory below! Example: C:\KISS\CM3D2
SelectDirDesc=Where is your game located?

[CustomMessages]

;Startup Messages
ScamWarning=If you paid for LMMT or downloaded it from anywhere that is not the official GitHub page, than you have been scammed or misled!
StorageSpaceLow=We detected that your AppData containing partition(Typically your C drive) does not have enough free space for cache. Please clear a minimum of 5 GiBs to install LMMT. You Have %1MBs
StorageSpaceLow2=The drive holding the path you have selected does not contain enough space to safely install LMMT. Please clear a minimum of 5 GiBs to install LMMT to this directory: You have %1MBs
...
ReadmeExit=Go back and read it before installing LMMT
...
CMDetected=This is COM3D2 not CM3D2! LMMT was not made for COM3D2! For COM3D2, please use COM Modular Installer (CMI)
NotaGameDir=This does not appear to be a CM3D2 Directory! We can still continue the installation but you may be installing to the wrong directory, some functions will also be rendered ineffectual. Do we continue anyways?
ImproperUpdate=We have detected that this game instance was updated improperly!(Usually by a drag and drop process) This is completely unsafe and WILL break your game.%n%nDue to this LMMT will not install as you may encounter further errors and bugs if we continue. Please reinstall your game and update CORRECTLY (By placing the update/DLC files in an empty directory and using the provided update.exe or selector.exe) to continue.
IsInDownload=It seems your game is located in the Downloads directory, this can cause issues with UAC and lead to improper LMMT installs! Please move it somewhere safer (Example: C:/KISS/CM3D2)
IsInProgramFiles=It seems your game is located in the Program Files directory, this can cause issues with UAC and lead to improper LMMT installs! Please move it somewhere safer (Example: C:/KISS/CM3D2)
IsINM=We have detected INM! INM is not supported by LMMT due to technical differences.%n%nTo use LMMT, please install the R18/Adult Content Supplement Patch.%n%nIf your are not actually on an INM version of the game, then you have likely installed Eng DLC/files into your japanese game. Please refer to the readme on repair instructions.

GameOutdated=Your game is outdated! Please update it immediately.%n%nMinimum Version: %1%n%nFound Version: %2
GameUnsupported=Your game is on a version that is not supported! Either downgrade or get a version of LMMT that is compatible!%n%nUnsupported Version:%1 or Newer%n%nFound Version:%2

MissingUpdateLst=While this appears to be a game folder, there is no Update.lst file! This is very bad!%n%nPlease update your game immediately and ensure that your game is functioning before attempting to install LMMT again.
...
CannotRenameOld=The OldInstall folder could not be renamed but the installation is already complete. As a result, we will not abort as the error is harmless. It should be automatically renamed the next time LMMT is run.
...
Survey=Open the Feedback Survey for LMMT